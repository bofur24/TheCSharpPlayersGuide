...
namespace DiscountedInventory
{
    class Program
    {
        static void Main(string[] args)
        {
                ...
                if (name == "Keith")
                {
                    Console.WriteLine("You get a 50% discount for helping fix my store.");
                    switch (choice)
                    {
                        case 1:
                            ...
                            break;
                        case 2:
                            Console.WriteLine("Torches cost 7 gold");
                            break;
                        case 3:
                            Console.WriteLine("Climbing Equipment cost 12 gold");
                            break;
                        case 4:
                            Console.WriteLine("Clean Water cost free");
                            break;
                        case 5:
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            Console.WriteLine("Food Supplies cost free");
                            break;
                    }
                }
                else 
